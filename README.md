...
## 🚀 現行バージョン：**v47**（2026-04-24 最終版）

- ドメイン表記：`v-aibou.com` / `vaizo.jp`
- 公開前暫定版（PINゲート `0415` 付き）
- カラー：白黒エディトリアル + CTAアクセント **#D7481F（バーントシエナ）**
- Heroアニメ：ロゴ1文字落下 → タグラインclip-path wipe → 黒マーカー後書き反転 → オレンジバー一閃 → CTAバウンド → **マウス追従パララックス + パーティクル浮遊**
- 読み込み最適化：CSS@import撤廃・フォント軽量化・画像CLS対策済
...
│   ├── v44_20260424_最終版.html
│   ├── v46_20260424_particles_perf.html
│   └── v47_20260424_最終版.html  ← ★LP公開用最終スナップショット
└── .git/                         ← GitHubリポジトリ連携
```
